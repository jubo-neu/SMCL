...
parser.add_argument("--datadir", "-D", type=str, help="Dataset directory; note: different from usual, directly use the thing please")
parser.add_argument("--output", "-O", type=str, default="eval", help="Root path of rendered output (our format, from eval.py)")
parser.add_argument("--dataset_format", "-F", type=str, default="dvr", help="Dataset format, nerf | srn | dvr")
parser.add_argument("--list_name", type=str, default="softras_test", help="Filter list prefix for DVR")
...
parser.add_argument("--exclude_dtu_bad", action="store_true", help="exclude hardcoded DTU bad views")
...
parser.add_argument("--viewlist", "-L", type=str, default="", help="Path to source view list e.g. src_dvr.txt; if specified, excludes the source view from evaluation")
parser.add_argument("--eval_view_list", type=str, default=None, help="Path to eval view list")
parser.add_argument("--primary", "-P", type=str, default="", help="List of views to exclude")
...
parser.add_argument("--metadata", type=str, default="metadata.yaml", help="Path to dataset metadata under datadir, used for getting category names if --multicat")
parser.add_argument("--dtu_sort", action="store_true", help="Sort using DTU scene order instead of lex")
